...
var MembersListComponent = (function () {
    ...
    MembersListComponent.prototype.searchKeyPressed = function () {
        this.from = 0;
    };
    MembersListComponent.prototype.moveForward = function () {
        this.from += this.itemsInPage;
    };
    MembersListComponent.prototype.moveBackwards = function () {
        this.from -= this.itemsInPage;
    };
